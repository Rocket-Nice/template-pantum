<?php get_header();
/* Template Name: Товары. Лазерные девайсы*/
?>
			...
			<div class="sidebar__left sidebar-left">
				<ul class="sidebar-left__list">
					...
					<li class="sidebar-left__item accordion sidebar-left__item--product">
						<h2 class="sidebar-left__title sidebar-left__title--drop-down accordion__control laser f-18">
							<a class="sidebar-left__link">Лазерные устройства</a>
						</h2>

						<ul class="sidebar-left__inner-list consumables-menu accordion__content">
							<?php
							$current_page_id = 349;
							$prodRepeat = get_field('filtr_elements', $current_page_id);
								...
								foreach ($prodRepeat as $item) : ?>
									<li class="consumables-menu__item accordion-inner">
										<h3 class="consumables-menu__title f-16 fb accordion-inner__control">
											<a class="consumables-menu__link"><?= $item['filtr_elements_title']; ?></a>
										</h3>

										<ul class="consumables-menu__inner-list accordion-inner__content">
											<?php
											if ($item['filtr_elements_elements']) :
												foreach ($item['filtr_elements_elements'] as $i) : ?>
													<li class="consumables-menu__inner-item">
														<a class="consumables-menu__inner-link">
															<span class="consumables-menu__checkbox"><?= $i['filtr_elements_elements_title']; ?></span>
														</a>
													</li>
											<?php endforeach;
											endif; ?>
					...
					<li class="sidebar-left__item sidebar-left__item--product">
						<h2 class="sidebar-left__title accordion__control f-18 label">
