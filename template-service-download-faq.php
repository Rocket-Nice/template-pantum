			...
			<div class="sidebar__right sidebar-right bg-fff bra ">
				...
				<div class="sidebar-right__video-search video-search download-search">
					...
					<div class="download-search__search">
						<h2 class="video-search__title f-22 fb">Пожалуйста, опишите вашу проблему</h2>
						<div class="download-search__buttons mt15">
							<input type="text" name='download-search' id='downloadSearch' class="download-search__search-field" autocomplete="off" placeholder="Пример: Как подключить Wi-Fi">
				...
				<div class="faq-container">
					<div class="sidebar-right__faq faq mt100">

						<h2 class="video-search__title f-24 c-000 fb">Популярные запросы</h2>
						<ul class="faq__list mt30">
							<?php if ($listQuery->have_posts()) : while ($listQuery->have_posts()) :
									$listQuery->the_post(); ?>
									<li class="faq__item">
